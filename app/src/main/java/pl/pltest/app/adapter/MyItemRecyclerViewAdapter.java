...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    private final ItemFragment.OnRecycleItemClickListener mListener;
     ...
     * @param listener    点击事件
     */
    public MyItemRecyclerViewAdapter(List<DataBean> beanList, int columnCount, ItemFragment.OnRecycleItemClickListener listener) {
        mBeanList = beanList;
        mListener = listener;
